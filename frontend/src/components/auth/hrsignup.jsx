            ...
            <main className='container-page grid gap-10 py-12 lg:grid-cols-[1.05fr_1fr]'>
                <section className='card-surface relative overflow-hidden p-8'>
                    ...
                    <div className='relative'>
                        ...
                        <h1 className='mt-4 font-display text-3xl text-ink-900 dark:text-ink-100'>
                            Create your HR account and start hiring.
                        </h1>
                        <p className='mt-4 text-lg text-ink-600 dark:text-ink-300'>
                            Connect with top student talent, review portfolios, and manage your hiring pipeline — all in one place.
                        </p>
                ...
                <section className='card-surface p-8'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <h2 className='font-display text-2xl text-ink-900 dark:text-ink-100'>Create your HR account</h2>
                        <p className='text-sm text-ink-600 dark:text-ink-300'>Use your work email to start the onboarding flow.</p>
                    </div>
